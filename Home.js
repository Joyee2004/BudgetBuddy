...
return(
    ...
    <div className="img-wrapper">
        <img src="/img/home1.webp" alt ="h"  className='back-img'/>
        
            <div className='back-text'>
           <h1>Online Expense Management</h1>
